...
import AlbumGrid from "@/components/admin/mainhead";
...
import Orders from "@/components/admin/assets";
import Orders2 from "@/components/admin/baskets";
...
const HomeContent = () => {
  ...
  return (
    <div>
      ...
      {!selectedAlbum && (
        <AlbumGrid onAlbumClick={(album) => setSelectedAlbum(album)} />
      )}

      {/* Show form when album is selected */}
      {selectedAlbum && (
        <UploadForm
                ...
                <nav className="relative flex flex-1 flex-col">
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    {/* <li className="mt-auto">
                      <a
                        href="#"
                        className="group -mx-2 flex gap-x-3 rounded-md p-2 text-md/6 font-semibold text-gray-700 hover:bg-[#333940] hover:text-white"
                      >
                        <Cog6ToothIcon
                          aria-hidden="true"
